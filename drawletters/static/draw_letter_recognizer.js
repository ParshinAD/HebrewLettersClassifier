...
function nothing() {
	document.getElementById("prediction").style.display = "none";
	document.getElementById("answer_reaction").innerHTML = "Unfortunately, right now the model can only predict Hebrew letters, in the future, I hope it will be improved... But you can draw anything, if you like :)";
}
