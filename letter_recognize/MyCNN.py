...
def CNN_predict_on_one_image(image, parameters):
    ...
    # Forward propagation
    model = ConvNet1(input_dimension=(28, 28, 1), weight_scale=1e-2, hidden_dimension=100, number_of_classes=27)
...
def CNN_train_on_one_image(image, parameters, Y, learning_rate=0.0001):
    ...
    # Forward propagation
    model = ConvNet1(input_dimension=(28, 28, 1), weight_scale=1e-2, hidden_dimension=100, number_of_classes=27, regularization=1e-3)
    model.params = parameters
